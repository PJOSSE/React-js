...
function Projet() {
    ...
    return (
        <div className='bav-Accueil'>
            ...
            <p><strong>Pour l'entrepreuneur</strong> et ses employés, rendre le stock facile d'usage avec <strong>des données concrètes à leur service</strong> : données sur les produits consommés et leurs quantités restantes, 
                durée de conservation restante et système <strong>pour un réapprovisionnement simplifié</strong> </p> 
